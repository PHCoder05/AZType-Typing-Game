...
Mainscreen.title('Typing Test Game')
# Mainscreen.config(bg="D:\PYTHON\Micro-Prooject\type-speed-open.png")
bg = ImageTk.PhotoImage(file = "type.png")
label = Label(Mainscreen, image=bg)
# label.place(anchor=CENTER , height = 800 , width = 600)
label.place( x = 0 , y =0)
score=0
missed=0
time=60
...
def movingtext():
    ...
    floatingtext='Python Typing Test Game '
    # playsound('D:/PYTHON/Micro-Project/gaming.mp3')
...
startlabel=Label(Mainscreen,text='Start Typing',font=('arial',20,
                  'italic bold'),bg='black',fg='white')
startlabel.place(x=320,y=50)
...
gameinstruction= Label(Mainscreen,text='Hit enter button after typing the word',
                       font=('arial',10,'italic bold'),fg='grey')
